...
class MyEmployeeFragment : Fragment() {
    ...
    private var users = mutableListOf<MyEmployee>()
    private lateinit var admin: Bruker

    val henrik = MyEmployee("henrik", "henrik@gmail.com", "Serviør")
    val lisz = MyEmployee("Liza", "Liza@gmail.com", "Vaktsjef")
    val greogor = MyEmployee("Gregor", "gregor@gmail.com", "Vaktsjef")
    val katerina = MyEmployee("Katerina", "kat@gmail.com", "Vaktsjef")
    val dragana = MyEmployee("dragana", "dragana@email.com", "Kokk")
